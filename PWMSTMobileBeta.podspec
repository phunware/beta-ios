...
DESC
    ...
    s.source                = { :git => "https://github.com/phunware/beta-ios.git", :tag => 'PWMSTMobileBeta-1.2.0' }
    s.ios.vendored_frameworks = 'Framework/Mobile.framework'
