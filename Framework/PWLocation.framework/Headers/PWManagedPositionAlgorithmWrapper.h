...
- (void)setCMXRawEstimatedLocation:(CLLocationCoordinate2D)coordinate floorId:(NSInteger)floorId;
- (void)setVBRawEstimatedLocation:(CLLocationCoordinate2D)coordinate floorId:(NSInteger)floorId;
- (void)runAlgorithm;
