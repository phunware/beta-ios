...
/// \param className The parsed class name of the view controller.
///
- (void)viewWillAppearWithClassName:(NSString * _Nonnull)className;
/// Called on viewDidDisappear for each view controller. Used internally.
/// \param className The parsed class name of the view controller.
///
- (void)viewDidDisappearWithClassName:(NSString * _Nonnull)className;
