 ...
 */
@property (readonly) NSString *movement;
 ...
 */
@property (readonly) PWRouteInstructionDirection movementDirection;

/**
 * The heading of the movement relative to true north. Expressed as an angle in degrees between 0 and 360.
 */
@property (readonly) CLLocationDirection movementTrueHeading;
 ...
 */
@property (readonly) PWPointOfInterest *startPointOfInterest __deprecated;
 ...
 */
@property (readonly) PWPointOfInterest *endPointOfInterest __deprecated;
